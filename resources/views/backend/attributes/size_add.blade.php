    ...
    <div class="row row-sm mg-t-20">
      <div class="col-xl-8 m-auto">
        <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
            <div class="list">
                <a class="float-right mg-b-10 btn btn-outline-primary" href="{{ route('SizeList') }}"> <i class="fa fa-list"></i> View Size List</a>
            </div>
          ...
          <p class="mg-b-20 mg-sm-b-30">A basic form where labels are aligned in left.</p>
            <form action="{{ route('SizePost') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control @error('size_name') is-invalid @enderror" value="{{ old('size_name') }}" placeholder="Size Name" name="size_name">
                    @error('size_name')
