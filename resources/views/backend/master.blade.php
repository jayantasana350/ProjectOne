...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Jayanta Sana</a></div>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          ...
          <ul class="sl-menu-sub nav flex-column">
            {{-- <li class="nav-item"><a href="{{ route('RoleAdd') }}" class="nav-link">Add Role</a></li> --}}
            <li class="nav-item"><a href="{{ route('RoleView') }}" class="nav-link">View</a></li>
          </ul>
          <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('AddCategory') }}" class="nav-link">Add Category</a></li>
            <li class="nav-item"><a href="{{ route('CategoryList') }}" class="nav-link">View Category</a></li>
            <li class="nav-item"><a href="{{ route('SubCategoryAdd') }}" class="nav-link">Add SubCategory</a></li>
            <li class="nav-item"><a href="{{ route('SubCategoryList') }}" class="nav-link">View SubCategory</a></li>
          </ul>
          <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('BrandAdd') }}" class="nav-link">Brand Add</a></li>
            <li class="nav-item"><a href="{{ route('BrandList') }}" class="nav-link">Brand View</a></li>
            <li class="nav-item"><a href="{{ route('ColorAdd') }}" class="nav-link">Color Add</a></li>
            <li class="nav-item"><a href="{{ route('ColorView') }}" class="nav-link">Color View</a></li>
            <li class="nav-item"><a href="{{ route('SizeAdd') }}" class="nav-link">Size Add</a></li>
            <li class="nav-item"><a href="{{ route('SizeList') }}" class="nav-link">Size View</a></li>
          </ul>
          <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-person-stalker tx-20"></i>
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('UserList') }}" class="nav-link">User List</a></li>
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('ProductAdd') }}" class="nav-link">Add Products</a></li>
            <li class="nav-item"><a href="{{ route('ProductList') }}" class="nav-link">View Products</a></li>
          </ul>
